...
# Build environment
grub_target_cc='gcc'
grub_target_cc_version='gcc (Debian 10.2.1-6) 10.2.1 20210110'
...
grub_target_cppflags=' -Wall -W  -DGRUB_MACHINE_PCBIOS=1 -DGRUB_MACHINE=I386_PC -m32 -nostdinc -isystem /usr/lib/gcc/x86_64-linux-gnu/10/include -I$(top_srcdir)/include -I$(top_builddir)/include'
